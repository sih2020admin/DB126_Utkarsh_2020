...
--
-- Host: localhost:3306
-- Generation Time: Jul 16, 2020 at 09:13 PM
...
CREATE TABLE `e_tender_vendor` (
  ...
  `vd_id` int NOT NULL,
  `vcd_id` int NOT NULL,
  `bidding_amt` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `is_approved` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  ...
  `time_period` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `reasons` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(96, 170, 104, 28, '20000', '0', NULL, '1111', 'Thane', '2020-07-13T14:23:11.382Z', NULL, NULL),
(97, 168, 103, 27, '5000', '0', NULL, '100', NULL, NULL, NULL, NULL),
(98, 170, 103, 27, '500', '0', NULL, '110', NULL, NULL, NULL, NULL),
(99, 171, 106, 30, '121000', '0', NULL, '1111', 'ulhasnagar', '2020-07-13T15:05:04.353Z', NULL, NULL),
(100, 170, 57, 19, '200', '0', NULL, '111', NULL, NULL, NULL, NULL),
(101, 172, 91, 23, '11', '0', NULL, '111', NULL, NULL, NULL, NULL),
(102, 170, 91, 23, '11', '0', NULL, '110', NULL, NULL, NULL, NULL),
(103, 170, 63, 22, '4000', '0', NULL, '110', NULL, NULL, NULL, NULL),
(104, 171, 91, 23, '11', '0', NULL, '1111', 'MUMBAI', '2020-07-14T10:43:48.249Z', NULL, NULL),
(105, 174, 57, 19, '300', '0', NULL, '110', NULL, NULL, NULL, NULL),
(106, 177, 57, 19, '500', '0', NULL, '111', NULL, NULL, NULL, NULL),
(107, 177, 91, 23, '11', '0', NULL, '111', NULL, NULL, NULL, NULL);
...
(63, 'fghjk', 'dfghjk', '2020', 'v@gmail.com', '7894561230', 'bhunji', '21', '-1', '2127', '456789', '0', '6894561230', '0', '789456123012352', NULL, NULL, NULL, NULL, NULL),
...
CREATE TABLE `vendor_file` (
  `vd_id` int NOT NULL,
  `file_uri` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
--
ALTER TABLE `e_tender_vendor`
  MODIFY `etd_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
--
...
--
ALTER TABLE `file_uri`
  MODIFY `furi_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
--
