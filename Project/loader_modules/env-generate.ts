...
export class ENV {
    constructor(development_folder_path: string, development_env_path: string, production_folder_path: string, production_env_path: string, json_path: string) {
        ...
        var loader_json = fs.readJSONSync(json_path)
        for (let i in loader_json) {
            for (let j in loader_json[i]) {
