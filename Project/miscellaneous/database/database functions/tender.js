...
async function confirmedTenderDetails(request) {
    let temp = await connection_1.default.query(`SELECT et_id,et_title,et_tender_fee,et_tender_ref_no,et_bidding_date,maximum_bid FROM  e_tender_details WHERE et_id = '${request.query['et_id']}';
