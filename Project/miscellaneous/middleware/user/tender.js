...
exports.validateURLParamsD_preview = exports.previewTender = exports.confirmTender = exports.applyTender = exports.validateURLParamsD = exports.validateURLParams = exports.validateURLParamsDApply = exports.validateURLParamsApply = void 0;
...
async function applyTender(request, response, next) {
    let status = await connection_1.default.execute(`SELECT etd_id,  cast( AES_DECRYPT(status ,'${key}') as char ) as status FROM  e_tender_vendor WHERE et_id = '${request.query['et_id'].toString()}' and vd_id ='${request.signedCookies['vd_id_e']}'`);
