...
xhr.onload = function () {
    if (this.status == 200) {
        ...
        if (response[2].length > 0) {
            ...
            for (i = 0; i < response[2].length; i++) {
                var tender_data =
                    `
                            <tr>
                                <td>` +
                    response[2][i].et_tender_ref_no +
                    `</td>
                                <td>` +
                    response[2][i].et_title +
                    `</td>
                                <td>` +
                    response[2][i].et_tender_fee +
                    `</td>
                                <td>` +
                    response[2][i].et_tender_desc +
                    `</td>
                            </tr><br>`
            ...
            tender_div.insertAdjacentHTML('beforeend', `<label class="RnoLabel"><strong>NO TENDER APPLIED YET ! APPLY FOR TENDER <a href="/tenders">here</a></strong></label>`)
        }
